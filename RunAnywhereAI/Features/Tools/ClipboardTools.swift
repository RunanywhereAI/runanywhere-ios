...
//  RunAnywhereAI
//
//  get_clipboard / set_clipboard — system pasteboard access. No permission
//  prompt on macOS; on iOS the system shows its own paste banner when
//  reading, which needs no Info.plist string.
//
    ...
    static var definition: ToolDefinition {
        ToolDefinition(
            ...
            description: """
                ...
                copied content ("summarise what I copied", "translate my clipboard"). The \
    ...
    static var executor: ToolExecutor {
        { _ in
            ...
            guard let text, !text.isEmpty else {
                return ["has_text": RAToolValue(false), "text": RAToolValue("")]
            }
            return [
